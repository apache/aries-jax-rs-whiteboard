...
public class SingletonServiceReferenceResourceProvider
    extends SingletonResourceProvider
    implements ServiceReferenceResourceProvider{

    public SingletonServiceReferenceResourceProvider(
        CachingServiceReference<?> cachingServiceReference, Object o) {
    ...
    public CachingServiceReference<?> getImmutableServiceReference() {
        return _cachingServiceReference;
    }
