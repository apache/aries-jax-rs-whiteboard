...
public class FrameworkStartLevelSchema extends FrameworkStartLevelDTO {
    ...
    public static FrameworkStartLevelSchema build(int initialBundleStartLevel, int startLevel) {
        final FrameworkStartLevelSchema frameworkStartLevelSchema = new FrameworkStartLevelSchema();
        frameworkStartLevelSchema.initialBundleStartLevel = initialBundleStartLevel;
        frameworkStartLevelSchema.startLevel = startLevel;
